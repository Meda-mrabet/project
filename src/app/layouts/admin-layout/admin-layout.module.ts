...
@NgModule({
  ...
  declarations: [
    ...
    providers: [MedicalRecordService,AuthService,ProfileComponent,LogoutGuard,TraitementService,TypeService,PraticientService ,SpecialiteService,AppointementsService ,OrdonnanceService, NgbActiveModal,FeedBackService,DocumentService
  ],
})
