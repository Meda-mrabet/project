...
import { CommandeDetailComponent } from "./consultation/consultation.component";
...
export class ColdComponent implements OnInit {
  ...
  async getAllCommandes() {
    ...
    this.commandeService.getCommandeCold().then(async (comm_: any) => {
      this.hourstempsRest=[]
  ...
  CreatePopUp() {
    this.modal.open(PopupCreateComponent, {
      size: '100%',
      centered: true,
      windowClass: 'dark-modal',  
