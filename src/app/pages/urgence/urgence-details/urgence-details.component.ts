...
@Component({
  selector: 'app-urgence-details',
  templateUrl: './urgence-details.component.html',
  styleUrls: ['./urgence-details.component.css'],
  providers: [
...
export class UrgenceDetailsComponent implements OnInit {
  minute:any
  hours:any
