...
import { UrgenceDetailsComponent } from './urgence-details/urgence-details.component';
...
dateSeconds=(this.dateNow.getTime()/86400000)
  async getAllCommandes() {
    ...
    this.commandeService.getCommandeUrgence().then(async (comm_: any) => {
      this.hourstempsRest=[]
  ...
  detail(commande: any, traitement: any) {
    const modalRef = this.modal.open(UrgenceDetailsComponent, {
      size: 'lg',
      centered: true,
