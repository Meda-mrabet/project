...
import { CommandeDetailComponent } from '../cold/consultation/consultation.component';
import { PopupCreateComponent } from '../cold/popup-create/popup-create.component';
import { UrgenceDetailsComponent } from '../urgence/urgence-details/urgence-details.component';
import { ArchivesDetailsComponent } from '../archives/archives-details/archives-details.component';
...
export class DashboardComponent implements OnInit {
  ...
  displayedColumns: string[] = ['No', 'nom', 'prenom', 'tel','problem','address','paiement','etat','tempsRest','details','raiting'];
  dataSource:any
  ls: any ;
 ...
 async ngAfterViewInit() {
  ...
  async getAllCommandes() {
      ...
      await this.traitementService.getAllTraitement().then(async (trait_: any) => {
  ...
  detail(commande: any, traitement: any) {
    const modalRef = this.modal.open(CommandeDetailComponent, {
      size: 'lg',
      centered: true,
      ...
      this.commandes.push(commande_);
       for(let i=0 ;i<this.traitements.length;i++){
        ...
        this.ELEMENT_DATA.push(
                    ...
                    console.log(this.commandes[i].etat?.[this.ls-1].title)
